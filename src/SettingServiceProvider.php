...
namespace WovoSchool\Setting;

use WovoSchool\Setting\Middleware\AutoSaveSetting;
use Blade;
...
class SettingServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        $this->publishes([
            ...
            __DIR__ . '/Migrations/2022_03_04_000000_create_settings_table.php' => database_path('migrations/2022_03_04_000000_create_settings_table.php'),
        ], 'setting');
