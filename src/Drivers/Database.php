...
namespace WovoSchool\Setting\Drivers;

use Illuminate\Database\Eloquent\Collection;
use WovoSchool\Setting\Contracts\Driver;
use WovoSchool\Setting\Support\Arr;
use Closure;
...
class Database extends Driver
{
    ...
    {
        //Get method moved to parse Read Data
        return $this->parseReadData($this->newQuery());
    }
