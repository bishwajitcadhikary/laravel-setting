...
```bash
composer require wovoschool/laravel-setting
```
...
```php
WovoSchool\Setting\SettingServiceProvider::class,
```

Add alias if you want to use the facade.

```php
'Setting' => WovoSchool\Setting\Facade::class,
```
...
```php
class MyDriver extends WovoSchool\Setting\Contracts\Driver
{
	// ...
}
